...
flags.DEFINE_string("model_type", "sentence", "Model type: e.g. 'sentence', 'token', etc.")
...
def create_model(bert_config,
    ...
    if model_type == "token":
        ...
        output_result = model.get_pooled_output()
...
def model_fn_builder(bert_config,
    ...
    def model_fn(features,
        ...
        embeddings = create_model(bert_config, input_ids, input_mask, segment_ids, use_one_hot_embeddings, model_type)
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            loss = global_step
            train_op = optimization.create_optimizer(global_step, 0.001, 0, 0, use_tpu)
